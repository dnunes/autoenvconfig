...
let _ = {
  'ensureMagicInstance': function (instance) {
    ...
    magicInstance = instance || publicFuncs.load();
  },
 ...
 'supermerge': function (o1, o2) { let r = {}, k, v;
  ...
  'ensureExtension': function (filename) {
...
let publicFuncs = {
  ...
  'getDefaultEnvID': function () {
    ...
    fileList.some((currentFile) => {
      ...
      envConfig = _.loadJSON(_.getConfigFilePath(currentFile));
  ...
  'get': function (key, def) { _.ensureMagicInstance();
...
class AutoEnvConfig {
  ...
  constructor(id) {
    this.id = id;
    let currentEnvFile = _.loadJSON(_.getConfigFilePath(id));
