...
let publicFuncs = {
  'enablePersistence': function (minInterval = 120/*, overrideCurrent = true */) {
    p_minInterval = minInterval;
    p_persistenceActive = true;
  },
  'disablePersistence': function () { p_persistenceActive = false; },
...
class EventualPersistence {
  ...
  update(key, value) {
    ...
    console.log('Igual? '+ (cur[last] == value));
...
class AutoEnvConfig {
  ...
  enablePersistence(minInterval, overrideCurrent = true) {
